...
#   POST /api/v1/guest/sessions/{qr_token}   (Phase 25 — this *is* the guest "login";
#                                              the qr_token itself is the credential)
...
# require_platform_scope / require_guest_tenant_scope, e.g. via
# `include_router(..., dependencies=[Depends(...)])`.
