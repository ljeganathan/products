...
| Stock-quantity tracking (POS/KOT low-stock badges) | ✅ basic, always on | ✅ + audit ledger + tenant on/off switch + KOT screen's Stock Management tab | ✅ + audit ledger + tenant on/off switch + KOT screen's Stock Management tab |
